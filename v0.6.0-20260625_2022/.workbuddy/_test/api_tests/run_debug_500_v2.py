...
LOCAL  = r"D:\work\website\OA\.workbuddy\_test\api_tests\debug_500_v2.py"
REMOTE = "/tmp/debug_500_v2.py"
...
print(f"\n🚀 执行 debug 脚本（开启 APP_DEBUG）...\n")
stdin, stdout, stderr = client.exec_command(
    f"python3 {REMOTE} 2>&1", timeout=120
)
