# D:\work\website\OA\.workbuddy\upload_and_run_v4.py
# 上传并运行V4版测试数据生成脚本
...
remote_path = '/tmp/generate_v4.php'
local_path = r'D:\work\website\OA\.workbuddy\generate_all_modules_v4.php'
