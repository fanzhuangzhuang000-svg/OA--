...
def main():
    ...
    try:
        ...
        with open('D:/work/website/OA/.workbuddy/generate_all_data_v2.php', 'r', encoding='utf-8') as f:
            php_script = f.read()
        ...
        # 上传base64编码的脚本
        ssh.exec_command(f'echo "{encoded_script}" | base64 -d > /tmp/generate_all_data_v2.php')
        time.sleep(3)
        
        # 检查文件是否上传成功
        stdin, stdout, stderr = ssh.exec_command('ls -lh /tmp/generate_all_data_v2.php')
        ...
        stdin, stdout, stderr = ssh.exec_command('php /tmp/generate_all_data_v2.php')
...
"""
        ...
        ssh.exec_command(f'echo "{encoded_check}" | base64 -d > /tmp/check_all_data.php')
        time.sleep(2)
        
        # 运行检查脚本
        stdin, stdout, stderr = ssh.exec_command('php /tmp/check_all_data.php')
        time.sleep(5)
        ...
        # 5. 清理临时文件
        ssh.exec_command('rm /tmp/generate_all_data_v2.php /tmp/check_all_data.php')
