...
TMP_PATH = '/tmp/generate_missing_data_correct.php'
FINAL_PATH = '/var/www/oa-api/generate_missing_data_correct.php'
LOCAL_PATH = 'D:/work/website/OA/.workbuddy/generate_missing_data_correct.php'
...
def main():
    ...
    try:
        ...
        # 执行PHP脚本（使用sudo -u www-data运行，确保能连接数据库）
        cmd3 = f"cd /var/www/oa-api && sudo -u www-data php {FINAL_PATH}"
        stdin, stdout, stderr = ssh.exec_command(cmd3, get_pty=True, timeout=600)
