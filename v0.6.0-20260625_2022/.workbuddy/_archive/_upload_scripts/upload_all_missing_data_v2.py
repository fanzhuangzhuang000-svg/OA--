...
TMP_PATH = '/tmp/generate_all_missing_data.php'
FINAL_PATH = '/var/www/oa-api/generate_all_missing_data.php'
LOCAL_PATH = 'D:/work/website/OA/.workbuddy/generate_all_missing_data.php'
