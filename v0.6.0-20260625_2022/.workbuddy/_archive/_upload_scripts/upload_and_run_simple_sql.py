...
try:
    ...
    print("\n上传 SQL 文件...")
    sftp = ssh.open_sftp()
    local_file = r'D:\work\website\OA\.workbuddy\test_data_simple.sql'
    remote_file = '/tmp/test_data_simple.sql'
    ...
    while True:
        ...
        if not line:
            break
        output += line
        if 'INSERT' in line or 'BEGIN' in line or 'COMMIT' in line or 'ERROR' in line:
            print(line.strip())
