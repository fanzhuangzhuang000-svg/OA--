        ...
        $presets = [
            ...
            'manager' => [
                ...
                'perms' => array_values(array_filter($allPerms, fn($n) =>
                    ...
                    str_starts_with($n, 'service.') ||
                    str_starts_with($n, 'sales.') ||
                    str_starts_with($n, 'vehicle.') ||
                    str_starts_with($n, 'construction.') ||
                    str_starts_with($n, 'warranty.') ||
                    str_starts_with($n, 'disk.') ||
